"""Experiment: Expanded universe momentum rotation backtest.

This experiment extends the locked baseline strategy to a 5-asset universe:
...
This allows direct comparison of diversification benefit vs. baseline 3-asset universe.
"""
...
def main() -> None:
    ...
    output_dir = Path("outputs_expanded_universe")
